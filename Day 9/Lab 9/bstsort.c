...
/*
 * run the test cases first, then let the user
 * try different array sizes for timing.
 */
int main() {
    char s[100];
    int nelements;
    ...
    /* keep asking until the user enters a blank line */
    int keepgoing = 1;
    ...
    while (keepgoing) {
         ...
         * a blank line stops the program.
         */
